...
word f_pc = [
	# Mispredicted branch.  Fetch at incremented PC
        # forward jump (M_valE stores valC)
        M_icode == IJXX && M_Cnd && M_valE >= M_valA : M_valE;
        # backward jump (M_valE stores valC)
...
word f_predPC = [
	...
	f_ifun == 0 && f_icode in { IJXX, ICALL } : f_valC;
...
word aluA = [
	...
	E_icode in { IRET, IPOPQ } : 8;
        # Stored for conditional jump, M_valE will store valC
...
word aluB = [
	...
	E_icode in { IRRMOVQ, IIRMOVQ } : 0;
        # Dummy value for conditional jump, M_valE will store valC
...
# It will store valP for IJXX
word e_valA = E_valA;
    # Pass valA through stage

# Store valC in valE for conditional jumps
#word e_valE = [
#     E_icode == IJXX : E_valC;
#     1: e_valE;
#];
